...
class _HomeApiService implements HomeApiService {
  ...
  @override
  Future<ProductModel> getNewArrivalsProduct() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<SliderImagesModel> getSliderImages() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SliderImagesModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'sliders',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SliderImagesModel _value;
    try {
      _value = SliderImagesModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ProductModel> searchBooks(String name) async {
    final _extra = <String, dynamic>{};
