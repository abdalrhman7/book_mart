...
class _CartApiServices implements CartApiServices {
  ...
  @override
  Future<CartModel> addToCart(Map<String, int> bookId) async {
  ...
  @override
  Future<CartModel> removeItemFromCart(Map<String, int> bookId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<CartModel> updateCart(UpdateCartModel updateCartModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updateCartModel.toJson());
    final _options = _setStreamType<CartModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
