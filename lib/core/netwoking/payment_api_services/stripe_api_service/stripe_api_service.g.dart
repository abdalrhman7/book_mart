...
class _StripeApiService implements StripeApiService {
  ...
  @override
  Future<EphemeralKey> createEphemeralKey(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<EphemeralKey>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'ephemeral_keys',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EphemeralKey _value;
    try {
      _value = EphemeralKey.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
